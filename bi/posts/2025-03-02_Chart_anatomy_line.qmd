...
date: "2025-03-02"
description: "If bar charts are the workhorses of data visualization, line charts are the storytellers. They’re the tool we reach for when we want to show how things..."
categories: [visualization, data-communication]
tags: [intermediate, chart-selection, clarity, data-presentation, ibcs]
format: html
---

![Illustration for Connecting the Dots: When Line Charts Are Your Best Friend](images/Anatomy_of_charts_line.jpg)
...
-   [Visualizing Form and Structure: Get in Shape with Data](2025-03-02_Chart_anatomy_shapes.qmd)
