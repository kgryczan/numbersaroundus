...
date: "2023-07-02"
description: "The world of data science is much akin to an intricate art form, resembling the detailed craftsmanship that goes into assembling a model airplane. Each..."
categories: [tidyverse, databases]
tags: [intermediate, data-cleaning, databases, data-wrangling, metaphor-driven]
format: html
---

![Illustration for From Hanger to Sky: Taking Flight with glue, janitor, and dbplyr](images/glue.jpg)
