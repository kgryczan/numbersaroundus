...
date: "2024-01-04"
description: "In the world of data analysis, every dataset is a trove of untold secrets waiting to be unearthed. These data-driven revelations can hold the key to..."
categories: [statistics, tutorials]
tags: [beginner-friendly, statistics]
format: html
---

![Illustration for Your Data's Untold Secrets: An Introduction to Descriptive Stats with R](images/descriptive.jpg)
...
![Illustration for Your Data's Untold Secrets: An Introduction to Descriptive Stats with R](https://cdn-images-1.medium.com/max/800/1*-GsOrECLMlt-My2OdY8kzQ.png)
...
![Illustration for Your Data's Untold Secrets: An Introduction to Descriptive Stats with R](https://cdn-images-1.medium.com/max/800/1*is2v89k8zXOjnz7pCVzMMA.png)
...
![Illustration for Your Data's Untold Secrets: An Introduction to Descriptive Stats with R](https://cdn-images-1.medium.com/max/800/1*LeFTvvdV9dAngrblqAtPXw.png)
...
![Illustration for Your Data's Untold Secrets: An Introduction to Descriptive Stats with R](https://cdn-images-1.medium.com/max/800/1*2jMDBAR4eCIlPh75OfbTvg.png)
...
![Illustration for Your Data's Untold Secrets: An Introduction to Descriptive Stats with R](https://cdn-images-1.medium.com/max/800/1*WmUr7BswWFEV5HgIyqQ14g.png)
...
-   [Old Art, New Code: The Typesetter's Guide to Memoization](2023-12-27_Old-Art--New-Code--The-Typesetter-s-Guide-to-Memoization-dc5c1873b498.qmd)
-   [Probably More Than Chance: A Beginner's Guide to Probability Distributions in R](2024-01-10_Probably-More-Than-Chance--A-Beginner-s-Guide-to-Probability-Distributions-in-R-8c09f35b224d.qmd)
