...
date: "2023-09-01"
description: "In the intricate landscape of machine learning, each algorithm and model is like a unique LEGO piece. They come in various shapes, sizes, and colors, each..."
categories: [machine-learning, tutorials]
tags: [intermediate, tidymodels, parsnip, metaphor-driven]
format: html
---

![Illustration for Parsnip: Where Machine Learning Models Snap Together Like LEGO Mindstorms](https://cdn-images-1.medium.com/max/800/1*ARK12GVh3uINx6qL74W6Vw.jpeg)
...
-   [The Swiss Army Knife of Data Preprocessing: Unfolding the Layers of recipes package](2023-08-28_The-Swiss-Army-Knife-of-Data-Preprocessing--Unfolding-the-Layers-of-recipes-package-d482421eba10.qmd)
-   [Metaphors in Motion: Machine Learning Illustrated with Tidymodels](2023-09-17_Metaphors-in-Motion--Machine-Learning-Illustrated-with-Tidymodels-fd6c0c5c0031.qmd)
