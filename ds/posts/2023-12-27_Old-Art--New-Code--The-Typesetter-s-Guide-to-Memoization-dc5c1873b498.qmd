...
date: "2023-12-27"
description: "In the world of programming, where complexity often intertwines with the need for efficiency, there exists a practice as ancient as it is modern:..."
categories: [r-programming, tutorials]
tags: [beginner-friendly, performance]
format: html
---

![Illustration for Old Art, New Code: The Typesetter's Guide to Memoization](images/memoisation.jpg)
...
-   [S(00)7 --- Agent with License for OOP](2023-12-21_S-00-7---Agent-with-License-for-OOP-3a24522e9bd5.qmd)
