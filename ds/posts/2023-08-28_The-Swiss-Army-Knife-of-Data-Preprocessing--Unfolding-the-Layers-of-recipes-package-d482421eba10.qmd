...
date: "2023-08-28"
description: "Data preprocessing is the backstage work that seldom receives the limelight but ensures that the main act --- machine learning models --- shine. Think of..."
categories: [machine-learning, tutorials]
tags: [intermediate, tidymodels, recipes, data-wrangling, metaphor-driven]
format: html
---

![Illustration for The Swiss Army Knife of Data Preprocessing: Unfolding the Layers of recipes package](images/recipes.jpg)
...
-   [Navigating the Future: Forecasting in the Era of Climate Change](2023-08-17_Navigating-the-Future--Forecasting-in-the-Era-of-Climate-Change-d467cac2304b.qmd)
