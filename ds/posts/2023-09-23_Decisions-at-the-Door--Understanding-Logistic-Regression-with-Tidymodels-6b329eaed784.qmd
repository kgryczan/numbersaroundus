...
date: "2023-09-23"
description: "Welcome back to the 'Metaphors in Motion' series! Today, we're stepping into the bustling world of nightclubs, where a discerning door bouncer stands,..."
categories: [machine-learning, statistics]
tags: [intermediate, tidymodels, logistic-regression, metaphor-driven]
format: html
---

![Illustration for Decisions at the Door: Understanding Logistic Regression with Tidymodels](images/logreg.jpg)
