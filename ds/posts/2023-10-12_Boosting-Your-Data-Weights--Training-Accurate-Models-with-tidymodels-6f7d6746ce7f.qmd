...
date: "2023-10-12"
description: "In the captivating realm of machine learning, myriad techniques continually evolve to enhance predictive accuracy, offering innovative pathways for..."
categories: [machine-learning, tutorials]
tags: [intermediate, tidymodels]
format: html
---

![Illustration for Boosting Your Data Weights: Training Accurate Models with tidymodels](images/xgboost.jpg)
...
![Illustration for Boosting Your Data Weights: Training Accurate Models with tidymodels](https://cdn-images-1.medium.com/max/800/1*LIymbXBQTeApEYJ58G8Rkw.png)
...
-   [From Standstill to Momentum: MLP as Your First Gear in tidymodels](2023-10-10_From-Standstill-to-Momentum--MLP-as-Your-First-Gear-in-tidymodels-a6f6987957b7.qmd)
-   [Unearthing Golden Nuggets of Data: A RegEx Treasure Hunt in R](2023-10-22_Unearthing-Golden-Nuggets-of-Data--A-RegEx-Treasure-Hunt-in-R-a017a7b0bf35.qmd)
