...
date: "2024-03-14"
description: "In the cosmic expanse of data science tools, a new starship has been unveiled --- Quarto. Crafted from the essence of RMarkdown, Quarto is engineered to..."
categories: [reporting, tutorials]
tags: [intermediate, quarto]
format: html
---

![Illustration for Navigating the Cosmos: Quarto, The Next Generation of Data Storytelling](images/quarto.jpg)
...
![Illustration for Navigating the Cosmos: Quarto, The Next Generation of Data Storytelling](https://cdn-images-1.medium.com/max/800/1*PVAvXz7lA-yIWlG3WiJoHw.png)
...
![Illustration for Navigating the Cosmos: Quarto, The Next Generation of Data Storytelling](https://cdn-images-1.medium.com/max/800/1*Qf0H5AoJYEqw-ne-RGTbrA.png)
...
![Illustration for Navigating the Cosmos: Quarto, The Next Generation of Data Storytelling](https://cdn-images-1.medium.com/max/800/1*yy0bybsLEwvFOPwsHSUa6A.png)
...
![Illustration for Navigating the Cosmos: Quarto, The Next Generation of Data Storytelling](https://cdn-images-1.medium.com/max/800/1*dsrgEw0p9XyoGa1lPeg8Jg.png)
...
-   [Arming Your Data Spaceship: Essential Quarto Tips and Tricks for the Modern Explorer](2024-03-21_Arming-Your-Data-Spaceship--Essential-Quarto-Tips-and-Tricks-for-the-Modern-Explorer-ead0fa787adb.qmd)
