...
description: "For each date group, populate the immediate last caller. So, first row in each date group will not have any immediate last caller. Note - data is unsorted."
...
![Illustration for Excel BI - Excel Challenge 630](/challenges/images/Exc630.jpg)
