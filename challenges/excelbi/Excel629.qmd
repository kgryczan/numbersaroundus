...
description: "If a number is preceded by + or -, change + to - and - to +. Ex. qw3-4+ty+8- = -4 and +8 will be replaced with +4 and -8 = qw3+4+ty-8-"
...
![Illustration for Excel BI - Excel Challenge 629](/challenges/images/placeholder-excelbi.png)
