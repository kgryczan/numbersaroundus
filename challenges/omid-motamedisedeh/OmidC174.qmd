...
description: "The task is to filter out rows where there is a greater value within two days before or after the current row. For example, if a value at a given row is..."
...
![Illustration for Omid - Challenge 174](/challenges/images/OmidC174.jpg)
...
-   [Omid - Challenge 175](OmidC175.qmd)
