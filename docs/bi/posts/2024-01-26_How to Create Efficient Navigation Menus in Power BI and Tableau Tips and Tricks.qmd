...
date: "2025-01-26"
description: "Let’s talk about something we all care about: making dashboards easy to navigate. Whether you’re building a simple sales overview or a detailed KPI..."
categories: [business-intelligence, tutorials]
tags: [intermediate, tableau, power-bi, dashboards]
format: html
---

![Illustration for How to Create Efficient Navigation Menus in Power BI and Tableau: Tips and Tricks](images/BI_Nav.jpg)
...
![Illustration for How to Create Efficient Navigation Menus in Power BI and Tableau: Tips and Tricks](images/clipboard-3277478810.png)
...
2.  Click **Buttons \>** **Navigator \> Page Navigator**.
    ...
    ![Illustration for How to Create Efficient Navigation Menus in Power BI and Tableau: Tips and Tricks](images/clipboard-145458239.png)
...
![Illustration for How to Create Efficient Navigation Menus in Power BI and Tableau: Tips and Tricks](images/clipboard-682757011.png)
...
![Illustration for How to Create Efficient Navigation Menus in Power BI and Tableau: Tips and Tricks](images/clipboard-334548443.png)
...
-   **Formatting:** You have ability to set font, border and background, what is extremely useful when you want to mimic PowerBI Navigator behaviour, of highlighting on which element you are currently.
    ...
    ![Illustration for How to Create Efficient Navigation Menus in Power BI and Tableau: Tips and Tricks](images/clipboard-2259520041.png)
...
-   [From Sketch to Masterpiece: Tableau Workspace for Beginners](2024-01-19_From Sketch to Masterpiece Tableau Workspace for Beginners.qmd)
-   [From Clicks to Insights: A Precise Comparison of Power BI and Tableau Interactivity](2025-02-02_From Clicks to Insights A Precise Comparison of Power BI and Tableau Interactivity.qmd)
