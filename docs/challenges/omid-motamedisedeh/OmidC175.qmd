...
description: "🔰 In the ID column, remove all instances of 'X' if it appears consecutively more than once."
...
![Illustration for Omid - Challenge 175](/challenges/images/OmidC175.jpg)
